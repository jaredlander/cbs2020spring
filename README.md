...
[Columbia Business
School](https://www8.gsb.columbia.edu/courses/mba/2020/spring/b8144-001).
...
``` sh
git clone https://github.com/jaredlander/cbs2020spring.git
```

Then open the `cbs2020spring.Rproj` file.
...
Paste `https://github.com/jaredlander/cbs2020spring`\[2\] in the
...
# get the repo
newProject <- usethis::use_course('https://github.com/jaredlander/cbs2020spring/archive/master.zip')
```
...
`cbs2020spring` or `cbs2020spring-master`. You can see this in the top
